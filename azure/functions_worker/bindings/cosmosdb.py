...
class CosmosDBConverter(meta.InConverter, meta.OutConverter, binding="cosmosDB"):
    @classmethod
    ...
    def from_proto(
        ...
        return cdb.DocumentList(cdb.Document.from_dict(doc) for doc in documents)
    ...
    def to_proto(
        ...
        return protos.TypedData(json=json.dumps([dict(d) for d in data]))


class CosmosDBTriggerConverter(
    CosmosDBConverter, binding="cosmosDBTrigger", trigger=True
):
    pass
