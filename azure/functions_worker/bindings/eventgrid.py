...
class EventGridEventInConverter(
    meta.InConverter, binding="eventGridTrigger", trigger=True
):
    @classmethod
    ...
    def from_proto(
        ...
        if trigger_metadata is None:
            raise NotImplementedError(f"missing trigger metadata for event grid input")
