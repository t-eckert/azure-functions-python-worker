...
class ServiceBusMessage(azf_sbus.ServiceBusMessage):
    ...
    def __init__(
        ...
        *,
        ...
        user_properties: typing.Dict[str, object],
    ) -> None:
...
class ServiceBusMessageInConverter(
    meta.InConverter, binding="serviceBusTrigger", trigger=True
):
    @classmethod
    ...
    def from_proto(
        ...
        return ServiceBusMessage(
            ...
            time_to_live=cls._parse_timedelta_metadata(trigger_metadata, "TimeToLive"),
